...
function lockToDecimalPlaces(value:number, decimalPlaces:number) {
...
class Mdct {
  ...
  private static SinTables: Float64Array[] = [];
  private static CosTables: Float64Array[] = [];
  ...
  public RunMdct(input: Float64Array, output: Float64Array): void {
    ...
    HCAUtilFunc.arrayCopy(input, 0, this._mdctPrevious, 0, input.length);
